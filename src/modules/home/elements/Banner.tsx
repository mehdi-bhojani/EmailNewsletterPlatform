  ...
  return (
    <div className='bg-[#f7f5ff] h-[95vh]'>
      ...
      <div className='w-full h-full flex justify-center items-center relative overflow-hidden'>
        <Image src={"https://media.beehiiv.com/cdn-cgi/image/fit=scale-down,onerror=redirect,format=auto,width=1920,quality=75/www/homepage/MobileHero.png"} alt='Banner' width={800} height={500} className='w-[80%] object-cover spin-slow' />
